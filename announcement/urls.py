...
urlpatterns = [
    ...
    path('download_assigned',dashboardview.download_sections,name='download_sections'),
    path('download_marklist',dashboardview.download_mark_list,name='download_mark_list'),
